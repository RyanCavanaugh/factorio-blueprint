...
export type EntityMap = { [entity_name: string]: EntityDescription; };

const DEFAULT_ENTITIES: EntityMap = { // ADD MORE (vanilla) AS YOU PLEASE (or modded if it's just for you)!
